...
export default {
  ...
  darkMode: ["class", '[data-mode="dark"]'], // Recognize `data-mode="dark"` for dark mode
...
plugins: [
  require('./src/app/static/plugins/headings.js'),
  require('./src/app/static/plugins/buttons.js'),
  require('./src/app/static/plugins/forms.js'),
  require('./src/app/static/plugins/card.js'),
  require('./src/app/static/plugins/drawer.js'),
  //third party libraries
  require('./src/app/static/plugins/flatpicker.js'),
  require('./src/app/static/plugins/simplebar.js'),
  require('./src/app/static/plugins/sweetalert2.js'),
  require('./src/app/static/plugins/swiper.js'),
  require('./src/app/static/plugins/tippy.js'),
  require('./src/app/static/plugins/toastify.js'),
  require('./src/app/static/plugins/choices.js'),
  require('./src/app/static/plugins/dropzone.js'),
  require('./src/app/static/plugins/colorpicker.js'),
  require('./src/app/static/plugins/ckeditor.js'),
  require('./src/app/static/plugins/datatable.js'),
  require('./src/app/static/plugins/apexcharts.js'),
  require('./src/app/static/plugins/maps.js'),
  require('./src/app/static/plugins/listjs.js'),
  require('./src/app/static/plugins/scroll-hint.js'),
  require('./src/app/static/plugins/multijs.js'),
  require('./src/app/static/plugins/fullcalendar.js'),
  require('./src/app/static/plugins/lightbox.js'),
